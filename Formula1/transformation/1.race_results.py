...
# final_df.write.mode("overwrite").format("parquet").partitionBy('race_id').save(f"{presentation_folder_path}/race_results")
...
# MAGIC %sql
# MAGIC select file_date , count(*) from f1_presentation.race_results
# MAGIC group by 1